...
public final class HttpUtils {
	...
	static {
		try {
			...
			MessageConstraints constraints = MessageConstraints.custom().setMaxHeaderCount(200).setMaxLineLength(100000).build();
			...
			httpClient = HttpClientBuilder.create().setRetryHandler(new DefaultHttpRequestRetryHandler(MAX_RETRY_TIMES, true))
    ...
    public static String getRequestURLWithParameter(String url,Map<String, String> params) {
